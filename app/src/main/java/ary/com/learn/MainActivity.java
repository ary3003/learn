...
/* This program is used to control just the basic commands of vlc media player. */
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this method for setting the onClickListener extends view.OnClickListener activity

        playButton.setOnClickListener(this);
        pauseButton.setOnClickListener(this);
        nextButton.setOnClickListener(this);
        previousButton.setOnClickListener(this);
        rightClickButton.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.pauseButton:
                if (isConnected && out!=null){
                    out.println(Constants.PAUSE); // send "pause" to server
                }
                break;
